import pandas as pd
file_path = r"D:\SEMESTER 2\Dasar Pemrograman\Sesi 12\data_penjualan.xlsx"
...
print("\nData elektronik di simpan di elektronik.xlsx")
...
print("\nData telah disimpan berdasarkan Total Harga dan disimpan di penjuaalan: ")